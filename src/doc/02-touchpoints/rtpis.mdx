...
<Immagine src="rtpis-wireframe2.png" caption="Esempio di flusso: un utente scansiona il QR presente alla pensilina e facilmente accede ad una pagina web con i dati di veicoli, orari e percorsi." />
