---
title: Dati in tempo reale con segnaletica digitale
category: Soluzioni Smart
slug: doc/real-time-data
...
Questo framework può essere suddiviso in due contesti: un contesto *pre-viaggio* e un contesto *durante il viaggio*. Il primo contesto fornisce informazioni come orari, tariffe e percorsi molto prima dell'inizio del viaggio, attraverso internet. Il secondo, invece, fornice informazioni quali geolocalizzazione e punti di interesse mentre si è in movimento.
...
Le fermate o le stazioni sono i punti in cui i passeggeri possono accedere all’ETA dei bus in arrivo. Per accedere a tali informazioni, qualora non fosse possibile installare un’unità video presso ogni fermata, si suggerisce di disporre un codice QR univoco: l’utente, scannerizzando il QR in questione, potrà visualizzare i dati della fermata in questione e lo stato degli bus in arrivo direttamente dal proprio smartphone.
